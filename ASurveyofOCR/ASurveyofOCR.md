...
- 从方法论的角度，回顾
    ...
    + 基于深度学习的方法
- OCR
    +  optical character recognition  专注为文档，ephoto-optical character recognition更具挑战
...
#### End-to-end text recognition system
...
#### Text detection and recognition in scene video
...
#### Multi-orientation text detection
- 近年来，针对多方向文本检测的研究越来越多，这似乎是近年来文本阅读在野外的发展趋势。
...
- Zhou  设计了一个快速、简单但功能强大的框架，用于检测多方向和多四边形文本。
    + 检测流程由两个阶段组成:
...
![bast-march](pic_resource/bast-march.PNG)
